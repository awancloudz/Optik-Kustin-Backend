<html>
    <head>
        ...
        <body>
            ...
            <center>{{ $transaksi->kodetransaksi }}</center><br>
            <table width="100%">
            <tr><td colspan="3"><b>TANDA TERIMA PESANAN (SO)</b></td></tr>
            <tr><td colspan="3">---------------------------------------------------------------------------</td></tr>
            <tr><th>Tanggal Pesan</th><td>: {{ date('d-m-Y', strtotime($transaksi->tanggaltransaksi)) }}</td><td>Jam {{ date('H:i', strtotime($transaksi->jamtransaksi)) }}</td></tr>
            <tr><th>Tanggal Selesai</th><td>: {{ date('d-m-Y', strtotime($transaksi->tanggalselesai)) }}</td><td>Jam {{ date('H:i', strtotime($transaksi->jamselesai)) }}</td></tr>
            ...
            <tr><th>Catatan</th><td colspan="2"></td></tr>
            <tr><td colspan="3" align="justify">{{ $transaksi->catatan }}</td></tr>
            <tr><td colspan="3">---------------------------------------------------------------------------</td></tr>
